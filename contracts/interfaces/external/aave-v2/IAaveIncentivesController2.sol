...
// Copy from https://github.com/aave/incentives-controller/blob/master/contracts/interfaces/IAaveIncentivesController.sol under terms of agpl-3.0 with slight modifications

pragma solidity ^0.8.0;

import { IAaveDistributionManager } from "./IAaveDistributionManager.sol";

interface IAaveIncentivesController2 is IAaveDistributionManager {
