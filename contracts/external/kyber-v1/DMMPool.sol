...
// Copy from https://github.com/KyberNetwork/dmm-smart-contracts/blob/master/contracts/DMMPool.sol under terms of BUSL-1.1 with slight modifications
...
import { FeeFomula } from "./lib/FeeFomula.sol";
import { ERC20Permit } from "./lib/ERC20Permit.sol";

import { IDMMPool } from "../../interfaces/external/kyber/IDMMPool.sol";
import { IDMMCallee } from "../../interfaces/external/kyber/IDMMCallee.sol";
import { IDMMFactory } from "../../interfaces/external/kyber/IDMMFactory.sol";
import { IERC20Metadata } from "../../interfaces/external/kyber/IERC20Metadata.sol";

import { VolumeTrendRecorder } from "./VolumeTrendRecorder.sol";
...
contract DMMPool is IDMMPool, ERC20Permit, ReentrancyGuard, VolumeTrendRecorder {
    ...
    constructor() ERC20Permit("KyberDMM LP", "DMM-LP", "1") VolumeTrendRecorder(0) {
    ...
    function mint(address to) external override nonReentrant returns (uint256 liquidity) {
        ...
        if (_totalSupply == 0) {
            ...
            _mint(address(uint160(type(uint256).max)), MINIMUM_LIQUIDITY); // permanently lock the first MINIMUM_LIQUIDITY tokens
        } else {
            liquidity = Math.min(
