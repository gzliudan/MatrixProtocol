...
// Copy from https://github.com/KyberNetwork/dmm-smart-contracts/blob/master/contracts/periphery/DMMRouter02.sol under terms of BUSL-1.1 with slight modifications
...
import { TransferHelper } from "../uniswap-v2/lib/TransferHelper.sol";
...
import { IERC20Permit } from "../../interfaces/external/kyber/IERC20Permit.sol";
...
contract DMMRouter02 is IDMMRouter02 {
    ...
    constructor(address _factory, IWETH _weth) {
        factory = _factory;
        weth = _weth;
    }
